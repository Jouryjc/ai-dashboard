...
function exportCurrentVersion(): void {
  ...
  const extension = session.artifactKind === 'business-app' ? 'zip' : 'html'
    ...
    <div class="flex h-12 items-center gap-2 px-3">
      ...
      <div class="flex min-w-0 items-center gap-2">
        ...
        <button
          ...
          @click="startEdit"
        >
          {{ session.dashboardName || (session.artifactKind === 'business-app' ? '未命名业务应用' : '未命名大屏') }}
        </button>
      ...
      <div class="flex items-center gap-1">
        ...
        <div class="relative">
          ...
          >
            ...
            <li>
              <!-- 大屏导出 HTML，业务应用导出可复现的 Vue 源码 ZIP -->
              <button
                type="button"
                class="flex w-full items-center justify-between px-3 py-1.5 text-left text-xs"
